...
[x] `0.5 pont` Főoldal: Ha be van jelentkezve jelenjen meg egy vásárlás gomb minden kártya alatt
    - ha nincs bejelentkezve is megjelenik, de ilyenkor ha ráklikkel, akkor a bejelentkezés oldalra navigál a gomb, nem pedig a vásárlásra
...
[x] `0.5 pont` Admin: Kártya módosítása: admin felhasználóval elérhető, még el nem adott kártyák esetén
    - amennyiben adminnal vagyunk bejelentkezve: a profilunkon a saját kártyáink között ha a nevére kattintunk, akkor fogjuk tudni módosítani a kártyát
