...
namespace Bomberman_Prototype1.Model.Entities.Monsters
{
    ...
    {
        public override string Type { get { return "seeking"; } }
        ...
        public SeekingMonster(int x, int y, string spritePath, int id, bool facade = false) : base(x, y, spritePath, id, facade)
        {
